...
void TIM_OC2Init(TIM_TypeDef* TIMx, TIM_OCInitTypeDef* TIM_OCInitStruct)
{
  ...
  TIMx->CCER &= (uint16_t)~TIM_CCER_CC2E;//cc2e, cc1e etc.
  ...
  tmpccmrx &= (uint16_t)~TIM_CCMR1_OC2M;//1,2,3 etc
  tmpccmrx &= (uint16_t)~TIM_CCMR1_CC2S;//1,2,3 etc
  
  /* Select the Output Compare Mode */
  tmpccmrx |= (uint16_t)(TIM_OCInitStruct->TIM_OCMode << 8);//1,2,3
  
  /* Reset the Output Polarity level */
  tmpccer &= (uint16_t)~TIM_CCER_CC2P;//1,2,3
  /* Set the Output Compare Polarity */
  tmpccer |= (uint16_t)(TIM_OCInitStruct->TIM_OCPolarity << 4);//1,2,3 etc
  
  /* Set the Output State */
  tmpccer |= (uint16_t)(TIM_OCInitStruct->TIM_OutputState << 4);//1,2,3 etc
  ...
  if((TIMx == TIM1) || (TIMx == TIM8))
  {
    ...
    /* Reset the Output N Polarity level */
    tmpccer &= (uint16_t)~TIM_CCER_CC2NP;//1,2,3 etc
    /* Set the Output N Polarity */
    tmpccer |= (uint16_t)(TIM_OCInitStruct->TIM_OCNPolarity << 4);//1,2,3 etc
    /* Reset the Output N State */
    tmpccer &= (uint16_t)~TIM_CCER_CC2NE;//1,2,3 etc
    
    /* Set the Output N State */
    tmpccer |= (uint16_t)(TIM_OCInitStruct->TIM_OutputNState << 4);//1,2,3 etc
    /* Reset the Output Compare and Output Compare N IDLE State */
