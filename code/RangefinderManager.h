...
public:
	...
	static uint8_t partition(uint8_t* input, uint8_t p, uint8_t r);
	static uint8_t quick_select(uint8_t* input, uint8_t p, uint8_t r, uint8_t k);
	static void calculateDistanceQsort(uint8_t* distArr, uint8_t i);
